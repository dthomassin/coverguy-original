...
<form id="order_review" method="post">
	...
	<div id="payment" style="display:block !important;">
		<?php $pay = false;  ?>
		<?php if( stristr( $_SERVER['REQUEST_URI'], '/order-pay/' ) || isset( $_REQUEST['pay_for_order'] ) ){ $pay = true; } ?>
		<?php if ( $order->needs_payment() || $pay ) : ?>
		...
		<div class="form-row">
			...
			<?php echo apply_filters( 'woocommerce_pay_order_button_html', '<input type="submit" onclick="thecoverguy_loading();" class="button alt" id="place_order" value="' . esc_attr( $order_button_text ) . '" data-value="' . esc_attr( $order_button_text ) . '" />' ); ?>
