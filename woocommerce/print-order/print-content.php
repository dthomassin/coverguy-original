...
?>
				...
				<div class="order-branding">
					...
					<div class="company-info">
						...
						<div class="company-address"><?php _e( 'Sales Person', 'thecoverguy' ); ?>: <?php echo get_post_meta( $order->post->ID, '_sales_person_name' , true ); ?></div>
						<div class="company-address"><?php _e( 'Order Status', 'thecoverguy' ); ?>: 
						<?php 
